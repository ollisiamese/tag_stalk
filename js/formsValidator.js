      ...
      $('#registerForm').validate({  
        rules: {
          username: {
            required: true,
            remote: {
              url:"../tagstalk/php/checkUserName.php",
              type: "post",
              data: {
                userName: function() {
                  return $('#username').val();
          ...
          email: {
            ...
            email: true,
            remote: {
              url: "../tagstalk/php/checkEmail.php",
              type: "post",
              data: {
                email: function() {
                  return $('#email').val();
        ...
        messages: {
          username: {
            required: "Username is required",
            remote: "This username is already taken, please choose a different one"
          },
          password: {
            required: "Password is required",
            minlength: "Password should be at least 6 characters long"
          ...
          password2: {
            required: "Password is required",
            passwordConfirm: "Please make sure your re-typed password matches the original"
          },
          email: {
            required: "Email is required",
            email: "Please enter a valid email address",
            remote: "An account tied to this email already exists, please choose a different one"
          }
        },  
